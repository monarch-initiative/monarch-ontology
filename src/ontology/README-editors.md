These notes are for the EDITORS of mo
...
Make sure you have an ID range in the [idranges file](mo-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [mo-edit.owl](mo-edit.owl)

** DO NOT EDIT mo.obo OR mo.owl in the top level directory **

[../../mo.owl](../../mo.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/monarch-initiative/monarch-ontology) for details.
 ...
 * [mo-idranges.owl](mo-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/mo_terms.txt file
...
Note: the mo_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as mo.owl and mo.obo and places
 ...
 * https://github.com/monarch-initiative/monarch-ontology/releases
 * https://github.com/monarch-initiative/monarch-ontology/releases/new
...
what is in the `owl:versionIRI` of the derived mo.owl (`data-version` in
mo.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/mo.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/mo/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/monarch-initiative/monarch-ontology.svg?branch=master)](https://travis-ci.org/monarch-initiative/monarch-ontology)
...
Note: if you have only just created this project you will need to authorize travis for this repo.
 ...
 3. Click the tick symbol next to monarch-ontology
